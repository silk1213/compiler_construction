...
%%
Def : ListDef {  $$ = new PDefs($1); YY_RESULT_Def_= $$; } 
  | Type _SYMB_52 _SYMB_0 ListArg _SYMB_1 _SYMB_2 ListStm _SYMB_3 {  std::reverse($4->begin(),$4->end()) ;$$ = new DefinitionFunction($1, $2, $4, $7); YY_RESULT_Def_= $$; }
  | _SYMB_49 Exp _SYMB_4 {  $$ = new DefinitionUsing($2); YY_RESULT_Def_= $$; }
  | _SYMB_48 _SYMB_52 _SYMB_5 Type _SYMB_6 Exp _SYMB_4 {  $$ = new DefinitionTypeDef($2, $4, $6); YY_RESULT_Def_= $$; }
;
...
ListArg : /* empty */ {  $$ = new ListArg(); YY_RESULT_ListArg_= $$; } 
  ...
  | Arg _SYMB_7 ListArg {  $3->push_back($1) ; $$ = $3 ; YY_RESULT_ListArg_= $$; }
;
...
Stm : Type _SYMB_52 _SYMB_4 {  $$ = new StatementDeclaration($1, $2); YY_RESULT_Stm_= $$; } 
  | Type _SYMB_52 _SYMB_7 ListId _SYMB_4 {  std::reverse($4->begin(),$4->end()) ;$$ = new StatementDeclarations($1, $2, $4); YY_RESULT_Stm_= $$; }
  | Type _SYMB_52 _SYMB_8 Exp _SYMB_4 {  $$ = new StatementInitialization($1, $2, $4); YY_RESULT_Stm_= $$; }
  ...
  | _SYMB_40 _SYMB_0 Type _SYMB_52 _SYMB_8 Exp _SYMB_4 Exp _SYMB_4 Stm _SYMB_1 Stm _SYMB_4 {  $$ = new StatementFor($3, $4, $6, $8, $10, $12); YY_RESULT_Stm_= $$; }
  ...
  | _SYMB_52 _SYMB_5 Type _SYMB_6 Exp _SYMB_4 {  $$ = new StatementTemplate($1, $3, $5); YY_RESULT_Stm_= $$; }
  | _SYMB_41 _SYMB_5 ListType _SYMB_6 _SYMB_4 {  std::reverse($3->begin(),$3->end()) ;$$ = new TemplateInstantiations($3); YY_RESULT_Stm_= $$; }
...
ListId : /* empty */ {  $$ = new ListId(); YY_RESULT_ListId_= $$; } 
  ...
  | _SYMB_52 _SYMB_7 ListId {  $3->push_back($1) ; $$ = $3 ; YY_RESULT_ListId_= $$; }
;
ListType : /* empty */ {  $$ = new ListType(); YY_RESULT_ListType_= $$; } 
  | Type {  $$ = new ListType() ; $$->push_back($1); YY_RESULT_ListType_= $$; }
  | Type _SYMB_7 ListType {  $3->push_back($1) ; $$ = $3 ; YY_RESULT_ListType_= $$; }
;
...
;
Exp9 : Exp _SYMB_5 Exp {  $$ = new ECoSm($1, $3); YY_RESULT_Exp_= $$; } 
  | Exp _SYMB_6 Exp {  $$ = new ECoGr($1, $3); YY_RESULT_Exp_= $$; }

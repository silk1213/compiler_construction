...
void Type_bool::printType() {
  std::cout << "bool" << std::endl;
}

std::string Type_bool::getType() {
  return "bool";
}

std::string Type_bool::getLLVMType() {
  return "i1";
}
...
void Type_int::printType() {
  std::cout << "int" << std::endl;
}

std::string Type_int::getType() {
  return "int";
}

std::string Type_int::getLLVMType() {
  return "i32";
}
...
void Type_double::printType() {
  std::cout << "double" << std::endl;
}

std::string Type_double::getType() {
  return "double";
}

std::string Type_double::getLLVMType() {
  return "double";
}
...
void Type_void::printType() {
  std::cout << "void" << std::endl;
}

std::string Type_void::getType() {
  return "void";
}

std::string Type_void::getLLVMType() {
  return "void";
}
...
void Type_string::printType() {
  std::cout << "string" << std::endl;
}

std::string Type_string::getType() {
  return "string";
}

std::string Type_string::getLLVMType() {
  return "string";
}
